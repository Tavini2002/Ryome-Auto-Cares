    ...
    <div>
      <div className="relative">
        ...
        <img src={imgSrc3} alt="Vacuum Image" className="absolute top-4 right-10 mx-60 rounded-2xl" style={{ width: "400px", height: "600px" }}/>
            <ul>
                <li className="ms-20  text-2xl font-semibold text-gray-400 dark:text-gray-400">Booking List</li>
                <li className="ms-20 my-10 text-2xl font-semibold text-gray-400 dark:text-gray-400">Appointment Calendar</li>
                <li className="ms-20 my-10 text-2xl font-semibold text-gray-400 dark:text-gray-400">Staff Shifts</li>
            </ul>
        </div>
      </div>
  );
